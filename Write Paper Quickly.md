...
#阅读论文
找到合适的，最热门的论文之后，浏览论文，在网上寻找对该论文的评论，看是否值得读，
如果值得读，就看该论文解决了什么问题，用的什么思路，如果第一遍不明白，就在网上找其他人的解释和评论
然后仔细研读里面的公式，找到该论文的代码，运行代码，
最后写笔记，让自己能够把该论文说明白
#重复试验，寻找突破
重复这些最新论文的试验，看是否有突破之处
如果有改进的办法，并且这些办法足够复杂，至少有两三个技术点需要描述，有数学背景支持，就可以成文
然后改进实验，收集数据
#准备足够多的表格，实验图，和模型图，以及算法描述
将这些素材按顺序整理在一起，这些是论文的骨架
#对论文拟好题目，书写大纲
不必计较细节，先大体写好
#先描述实验过程
